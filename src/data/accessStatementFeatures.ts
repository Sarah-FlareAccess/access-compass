...
export const ACCESS_STATEMENT_CATEGORIES: FeatureCategory[] = [
  ...
  },
  {
    ...
    features: [
      { label: 'Staff disability-awareness training', phrase: 'staff trained in disability awareness and confident to help', yesNo: ['4.2-F-1', '5.3-F-1'] },
      { label: 'Assistance animals welcome', phrase: 'a warm welcome for assistance animals and their handlers', yesNo: ['4.2-F-2', '5.1-F-6'] },
      { label: 'Companion Card accepted', phrase: 'the Companion Card, so your support person comes free', yesNo: ['4.3-D-3', '5.1-F-4'] },
