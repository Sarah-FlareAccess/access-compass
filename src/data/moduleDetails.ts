...
export const MODULE_DETAILS: Record<string, ModuleDetail> = {
  ...
  'B5': {
    id: 'B5',
    overview: 'This module helps you communicate clearly and accessibly across all channels, using plain language and multiple formats.',
    topics: [
      'Plain language principles',
      'Easy Read formats',
      'Auslan and sign language resources',
      'Alternative format options (large print, audio)',
      'Multilingual considerations',
      'Accessible email communication',
    ],
    whyMatters: 'Complex language and jargon create barriers for many people, including those with cognitive disabilities, low literacy, or who speak English as a second language. Clear communication is better for everyone.\n\nNearly half of Australian adults have low literacy levels that affect their daily lives. When you use plain language, you\'re not "dumbing down"—you\'re communicating effectively. Government agencies, banks, and healthcare providers are increasingly required to use plain language because it reduces errors, complaints, and the need for follow-up support. Clear communication saves time and money.',
    whoHelps: [
      'People with intellectual disabilities',
      'People with learning disabilities like dyslexia',
      'Deaf people who use Auslan as their first language',
      'People from culturally diverse backgrounds',
      'Older adults and anyone who prefers straightforward information',
    ],
  },
  'B6': {
    id: 'B6',
