...
const QUESTION_SPECIFIC_RECOMMENDATIONS: Record<string, {
  ...
  '1.5-DD-2a': {
    ...
    reasoning: 'Language training prevents well-meaning staff from using outdated terms that alienate customers with disability. Terms like "wheelchair-bound", "special needs", or "suffers from" cause real harm. Trained staff write better content and communicate more respectfully, which directly affects whether people with disability feel welcome and respected.',
    resources: [],
  },
  '1.5-DD-2b': {
