...
export default function ReportPage() {
  ...
  const handleGenerateReport = useCallback(() => {
    if (!isReady) return;
    const r = generateReport(reviewMode, organisationName, reportConfig, activeSiteName);
    setReport(r);
  }, [isReady, generateReport, reviewMode, organisationName, reportConfig, activeSiteName]);
  ...
  }, [isReady, hasCompletedModules, hasAutoGenerated, generateReport, reviewMode, organisationName, reportConfig, activeSiteName]);
  ...
  useEffect(() => {
    ...
    setReport(generateReport(reviewMode, organisationName, reportConfig, activeSiteName));
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [activeSiteName, generateReport]);
