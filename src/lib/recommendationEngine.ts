...
export const MODULES: ModuleDefinition[] = [
  ...
  { id: '1.3', name: 'Making a booking', journeyTheme: 'before-arrival', estimatedTime: 12, cost: 75,
  ...
  { id: '4.3', name: 'Payments and concessions', journeyTheme: 'during-visit', estimatedTime: 10, cost: 75,
  ...
  { id: '7.4', name: 'Performer, artist and talent access', journeyTheme: 'during-visit', estimatedTime: 12, cost: 110,
    description: 'Performer-side built environment, briefings, riders, paid disabled-artist consultancy, reasonable adjustments and operational performer access. Relevant if you book performers, artists, presenters or talent at any scale.' },
...
export const INDUSTRY_DEFAULT_MODULES: Record<string, string[]> = {
  'attractions': ['1.1', '2.1', '2.3', '4.2', '4.5', '3.3', '3.5', '3.8', '3.10'],
  'leisure-recreation': ['1.2', '2.1', '2.3', '4.2', '3.3', '3.5', '3.8'],
  'hospitality': ['1.1', '1.2', '1.3', '2.1', '3.1', '3.3', '3.6', '3.5', '4.1', '4.2', '4.5'],
  'events-venues': ['2.1', '2.3', '4.2', '3.3', '3.8', '6.1', '6.2', '6.3', '6.4', '6.5', '7.3'],
  'retail': ['1.1', '2.1', '2.3', '4.2', '4.5', '1.3', '3.10'],
  'local-government': ['1.1', '1.2', '2.1', '3.5', '4.2', '4.3', '4.5', '5.1'],
  'health-wellness': ['1.2', '2.1', '3.5', '4.2', '4.3', '3.8'],
  'education-training': ['1.1', '1.2', '2.1', '2.3', '3.1', '3.5', '4.1', '4.2', '5.1'],
  'tourism': ['1.1', '1.2', '2.1', '2.3', '4.2', '4.5', '3.8'],
  'accommodation': ['1.2', '1.3', '2.1', '3.2', '3.9', '4.2', '4.5'],
  'corporate': ['1.1', '1.2', '2.1', '2.3', '4.2', '5.1', '5.7', '5.8', '5.9', '5.10'],
  'cafe-restaurant': ['2.1', '3.1', '3.3', '3.6', '4.2', '4.5'],
  'tour-operator': ['1.1', '1.2', '2.1', '2.3', '4.2', '4.7', '3.8'],
  'attraction-museum-gallery': ['1.1', '2.1', '2.3', '4.2', '4.5', '3.3', '3.5', '3.8', '3.10'],
  'visitor-centre': ['1.1', '2.1', '2.3', '4.2', '4.5', '3.5'],
  'other': ['4.2', '1.1', '2.1'],
};
...
export const SERVICE_TYPE_PRIORITY: Record<string, string[]> = {
  ...
  'event': ['6.1', '6.2', '6.3', '6.4', '6.5', '2.1', '4.2', '3.8'],
  'other': [],
};
