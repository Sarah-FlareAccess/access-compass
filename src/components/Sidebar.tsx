  ...
  return (
    <aside className="dashboard-sidebar" role="complementary" aria-label="Sidebar navigation">
      ...
      <nav className="sidebar-nav" aria-label="Sidebar">
        ...
        {/* Your Outputs */}
        <div className="sidebar-section-title">Reports & plans</div>
        ...
        <Link to="/access-profile" className="sidebar-nav-item" aria-current={location.pathname === '/access-profile' ? 'page' : undefined}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <div className="sidebar-alerts-wrapper" ref={alertsRef}>
        <button
          ...
          title={showAlerts ? 'Close alerts' : 'Open alerts'}
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
